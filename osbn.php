			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<br />
						<small style="color:#666666; padding-left: 18px;">Die letzten <?php echo $options['article_count'] ?> Artikel werden angezeigt. Die Aktualisierung erfolgt stündlich</small>
					</td>				
				</tr>
	...
	public function widget($args, $instance) {
		...
		if ($options['articles'] == 1) {
			...
			if ($options['fixed_height']) {
				echo '<ul style="height: '.$options['widget_height'].'px; overflow-y: auto; clear: both; padding-right: 5px">'.$osbn_data['articles'].'</ul>';
			} else {
				echo '<ul style="clear: both;">'.$osbn_data['articles'].'</ul>';
			}
			echo '';
		}
		echo $after_widget;
